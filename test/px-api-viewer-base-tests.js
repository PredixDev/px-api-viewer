...
function runBaseTests() {
  px_api_viewer_1 = document.getElementById('px_api_viewer_1');

  suite('Base Automation Tests for px-api-viewer', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-api-viewer fixture is created', function() {
      assert.isTrue(document.getElementById('px_api_viewer_1') !== null);
    });
